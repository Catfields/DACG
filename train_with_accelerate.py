#!/usr/bin/env python3
"""
使用Hugging Face Accelerate框架的训练启动脚本
使用方法：
1. 安装accelerate: pip install accelerate
2. 配置accelerate: accelerate config
3. 运行训练: accelerate launch train_with_accelerate.py [参数]
"""
...
def parse_agrs():
    ...
    # Others
    parser.add_argument('--seed', type=int, default=9530, help='.')
    parser.add_argument('--resume', type=str, help='whether to resume the training from existing checkpoints.')
    parser.add_argument('--use_amp', action='store_true', help='whether to use automatic mixed precision training.')
